...
Original file is located at
    https://colab.research.google.com/drive/1xHM0MQNwSRTju7LHKWQwlb0qm2iJXyVq
"""
  ...
  def run(self, data, k_nn, sigma, epsilon):
    ...
    for iterations in range(10):
      ...
      while (tracker[clicks] > tracker[clicks-1] or clicks==1):
        ...
        #when we compare we need to set an epilon. From this we can calculate an accuracy which then we can break out the same as we did with classification this has to be done for the original here as well as the future things
        #Step 1 implement the error here.   done ##
        #Step 2 implement the error for the editing done## but maybe check in on this at some point
        #Step 3 prepare for mse mae in the last step.
