...
Original file is located at
    https://colab.research.google.com/drive/1vR0RPYUAcyC4Wev1jfCGzkGhAgk-bBaU
"""
...
for i in range(type_of_cross_v):
  testing_list = []
  training_list = []
  testing_list = random_list[i*testing_size:testing_size*(i+1)]
